...
```shell
# Plan A: docker pull (21.2GB)
IMAGE=harbor.baai.ac.cn/flagtree/flagtree-metax3.6-py312-torch2.8.0-metax3.7.2.0-ubuntu24.04:202606-base
docker pull ${IMAGE}
# Plan B: docker load (6.0GB)
...
python3.12 -m pip install flagtree===0.6.1a2+metax3.6 $RES
```
