...
参考 [Tests of sunrise3.6 backend](/.github/workflows/sunrise-build-and-test.yml)
...
参考 [Tests of sunrise3.4 backend](https://github.com/flagos-ai/FlagTree/blob/triton_v3.4.x/.github/workflows/sunrise-build-and-test.yml)
