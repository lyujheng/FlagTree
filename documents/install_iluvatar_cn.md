...
# Plan A: docker pull (19.2GB)
IMAGE=harbor.baai.ac.cn/flagtree/flagtree-iluvatar-py312-torch2.7.1-4.4.0release_f65d8ac7-ubuntu24.04:202606-3.6-base
docker pull ${IMAGE}
# Plan B: docker load (5.5GB)
IMAGE=flagtree-iluvatar-py312-torch2.7.1-4.4.0release_f65d8ac7-ubuntu24.04:202606-3.6-base
wget https://baai-cp-web.ks3-cn-beijing.ksyuncs.com/trans/flagtree-iluvatar-py312-torch2.7.1-4.4.0release_f65d8ac7-ubuntu24.04.202606-3.6-base.tar.gz
docker load -i flagtree-iluvatar-py312-torch2.7.1-4.4.0release_f65d8ac7-ubuntu24.04.202606-3.6-base.tar.gz
```
...
# llvm
wget https://baai-cp-web.ks3-cn-beijing.ksyuncs.com/trans/iluvatar-llvm22-x86_64_v0.6.0.tar.gz
tar zxvf iluvatar-llvm22-x86_64_v0.6.0.tar.gz
```
...
python3.12 -m pip install flagtree===0.6.0+iluvatar3.6 $RES
```
...
参考 [Tests of iluvatar3.6 backend](/.github/workflows/iluvatar3.6-build-and-test.yml)
...
参考 [Tests of iluvatar3.1 backend](https://github.com/flagos-ai/flagtree/blob/triton_v3.1.x/.github/workflows/iluvatar3.1-build-and-test.yml)
