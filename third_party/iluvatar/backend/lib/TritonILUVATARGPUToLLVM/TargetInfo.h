...
public:
  ...
  // direct-to-lds loads. Some architectures do not support
  // scattering and instead have to write warp coalesced into LDS
  bool supportsDirectToLDSScattering() const;

  // Some architectures require alias information on direct-to-lds loads
...
#endif // TRITON_THIRD_PARTY_ILUVATAR_LIB_TRITONILUVATARGPUTOLLVM_TARGETINFO_H_
