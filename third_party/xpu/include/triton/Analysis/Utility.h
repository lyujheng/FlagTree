...
#ifdef DEBUG_TYPE
#pragma push_macro("DEBUG_TYPE")
#undef DEBUG_TYPE
#define TRITON_XPU_RESTORE_DEBUG_TYPE
#endif
...
#undef DEBUG_TYPE
#ifdef TRITON_XPU_RESTORE_DEBUG_TYPE
#pragma pop_macro("DEBUG_TYPE")
#undef TRITON_XPU_RESTORE_DEBUG_TYPE
#endif
